...
class UserRepository:
    ...
    async def get_by_id(self, user_id: int) -> User | None:
        ...
        try:
            ...
            raise UserRepositoryError(
                f"Failed to get user by ID {user_id}: {str(e)}", original_error=e
            ) from e

    async def get_by_line_user_id(self, line_user_id: str) -> User | None:
    ...
    async def get_by_email(self, email: str) -> User | None:
        ...
        try:
            ...
            raise UserRepositoryError(
                f"Failed to get user by email {email}: {str(e)}", original_error=e
            ) from e
    ...
    async def get_all(self, limit: int = 100, offset: int = 0) -> list[User]:
        ...
        try:
            ...
            raise UserRepositoryError(
                f"Failed to get users: {str(e)}", original_error=e
            ) from e
    ...
    async def create(self, user_data: UserCreate) -> User:
        ...
        try:
            ...
            self.session.rollback()
            raise UserRepositoryError(
                f"Failed to create user: {str(e)}", original_error=e
            ) from e
    ...
    async def update(self, user_id: int, user_data: UserUpdate) -> User | None:
        ...
        try:
            ...
            self.session.rollback()
            raise UserRepositoryError(
                f"Failed to update user {user_id}: {str(e)}", original_error=e
            ) from e
    ...
    async def delete(self, user_id: int) -> bool:
        ...
        try:
            ...
            self.session.rollback()
            raise UserRepositoryError(
                f"Failed to delete user {user_id}: {str(e)}", original_error=e
            ) from e
    ...
    async def count(self) -> int:
        ...
        try:
            ...
            raise UserRepositoryError(
                f"Failed to count users: {str(e)}", original_error=e
            ) from e
