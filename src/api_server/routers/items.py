...
async def get_items(
    ...
    sort_by: ItemSortField = Query(
        default=ItemSortField.CREATED_AT, description="Field to sort by"
    ),
    ...
    max_price: float | None = Query(
        default=None, gt=0, description="Maximum price filter"
    ),
...
async def create_item(
    ...
    try:
        ...
        return ItemOperationResponse(
            success=True, message="Item created successfully", item=item
        )
...
async def update_item(
    ...
    try:
        ...
        return ItemOperationResponse(
            success=True, message="Item updated successfully", item=item
        )
