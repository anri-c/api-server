...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        ..., description="PostgreSQL database connection URL", env="DATABASE_URL"
    )
    ...
    line_client_id: str = Field(
        ..., description="LINE Login client ID", env="LINE_CLIENT_ID"
    )
    line_client_secret: str = Field(
        ..., description="LINE Login client secret", env="LINE_CLIENT_SECRET"
    )
    line_redirect_uri: str = Field(
        ..., description="LINE Login redirect URI", env="LINE_REDIRECT_URI"
    )

    # JWT Configuration
    jwt_secret: str = Field(
        ..., description="JWT secret key for token signing", env="JWT_SECRET"
    )
