...
class UserBase(SQLModel):
    ...
    display_name: str = Field(
        max_length=200, description="User's display name from LINE profile"
    )
...
class UserUpdate(SQLModel):
    ...
    display_name: str | None = Field(
        default=None, max_length=200, description="Updated display name"
    )
    picture_url: str | None = Field(
        default=None, max_length=500, description="Updated profile picture URL"
    )
    email: str | None = Field(
