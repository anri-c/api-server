...
class TestItemsEndpoints:
    ...
    def test_get_items_with_pagination(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.get(
                "/api/items/?page=1&page_size=2", headers=auth_headers
            )
    ...
    def test_get_items_with_search(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.get("/api/items/?search=Test Item", headers=auth_headers)
            ...
            for item in data["items"]:
                assert "Test Item" in item["name"] or "Test Item" in (
                    item["description"] or ""
                )
    ...
    def test_get_items_with_price_range(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.get(
                "/api/items/?min_price=5.00&max_price=15.00", headers=auth_headers
            )
    ...
    def test_get_items_with_sorting(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.get(
                "/api/items/?sort_by=name&sort_order=asc", headers=auth_headers
            )
    ...
    def test_create_item_invalid_data(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.post(
                "/api/items/", json=invalid_data, headers=auth_headers
            )
    ...
    def test_create_item_missing_required_fields(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            invalid_data = {"description": "Test description", "price": "10.00"}
    ...
    def test_update_item_success(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            update_data = {"name": "Updated Item Name", "price": "199.99"}

            response = client.put(
                f"/api/items/{test_item.id}", json=update_data, headers=auth_headers
            )
    ...
    def test_update_item_not_found(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.put(
                "/api/items/999", json=update_data, headers=auth_headers
            )
    ...
    def test_update_item_invalid_data(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.put(
                f"/api/items/{test_item.id}", json=invalid_data, headers=auth_headers
            )
    ...
    def test_delete_item_success(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            get_response = client.get(
                f"/api/items/{test_item.id}", headers=auth_headers
            )
...
class TestItemsEndpointsValidation:
    ...
    def test_create_item_price_validation(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            invalid_data = {"name": "Test Item", "price": "0.00"}
            response = client.post(
                "/api/items/", json=invalid_data, headers=auth_headers
            )
            assert response.status_code == 400
            ...
            invalid_data = {"name": "Test Item", "price": "-10.00"}
            response = client.post(
                "/api/items/", json=invalid_data, headers=auth_headers
            )
            assert response.status_code == 400
            ...
            invalid_data = {"name": "Test Item", "price": "1000001.00"}
            response = client.post(
                "/api/items/", json=invalid_data, headers=auth_headers
            )
            assert response.status_code == 400
    ...
    def test_get_items_price_range_validation(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.get(
                "/api/items/?min_price=100.00&max_price=50.00", headers=auth_headers
            )
            assert response.status_code == 400
...
class TestItemsEndpointsErrorHandling:
    ...
    def test_database_error_handling(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            with patch(
                "src.api_server.services.item_service.ItemService.get_items_for_user"
            ) as mock_service:
...
class TestItemsEndpointsDataIsolation:
    ...
    def test_user_data_isolation(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            item_data = {"name": "User1 Item", "price": "10.00"}
            response = client.post("/api/items/", json=item_data, headers=auth_headers)
            assert response.status_code == 201
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            item_data = {"name": "User2 Item", "price": "20.00"}
            response = client.post("/api/items/", json=item_data, headers=auth_headers)
            assert response.status_code == 201
    ...
    def test_cross_user_access_prevention(
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            item_data = {"name": "User1 Private Item", "price": "10.00"}
            response = client.post("/api/items/", json=item_data, headers=auth_headers)
            assert response.status_code == 201
            user1_item = response.json()
        ...
        with patch("src.api_server.dependencies.get_current_user_id") as mock_get_user:
            ...
            response = client.get(
                f"/api/items/{user1_item['id']}", headers=auth_headers
            )
            assert response.status_code == 403
            ...
            response = client.put(
                f"/api/items/{user1_item['id']}", json=update_data, headers=auth_headers
            )
            assert response.status_code == 403
