...
def sample_item_data() -> ItemCreate:
    ...
    return ItemCreate(
        name="Test Item", description="This is a test item", price=Decimal("99.99")
    )
...
@pytest.fixture(scope="function")
def test_item(
    test_session: Session, test_user: User, sample_item_data: ItemCreate
) -> Item:
...
async def async_test_session(test_engine) -> AsyncGenerator[Session]:
