...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_verify_line_access_token_invalid_token(self, auth_service: AuthService):
    ...
    @pytest.mark.asyncio
    async def test_verify_line_access_token_network_error(self, auth_service: AuthService):
    ...
    async def test_authenticate_line_user_success(
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            mock_responses = [
                Mock(status_code=200, json=Mock(return_value=sample_line_token_response)),
                Mock(status_code=200, json=Mock(return_value=sample_line_profile_response))
            ]
