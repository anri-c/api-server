...
class TestItemRepository:
    ...
    async def test_create_invalid_user_id(
        self, item_repository: ItemRepository, sample_item_data: ItemCreate
    ):
    ...
    def test_get_by_id_success(self, item_repository: ItemRepository, test_item: Item):
    ...
    def test_get_by_id_not_found(
        self, item_repository: ItemRepository, test_user: User
    ):
    ...
    def test_get_by_id_database_error(
        self, item_repository: ItemRepository, test_item: Item
    ):
    ...
    def test_get_by_id_or_raise_access_denied(
        ...
        assert (
            f"User {other_user.id} does not have access to item {test_item.id}"
            in str(exc_info.value)
        )

    def test_get_all_for_user_success(
        self, item_repository: ItemRepository, multiple_test_items: list[Item]
    ):
    ...
    def test_get_all_for_user_invalid_sort_field(
        ...
        with pytest.raises(ValueError) as exc_info:
            item_repository.get_all_for_user(test_user.id, sort_by="invalid_field")
    ...
    def test_get_all_for_user_invalid_sort_order(
        ...
        with pytest.raises(ValueError) as exc_info:
            item_repository.get_all_for_user(test_user.id, sort_order="invalid_order")
    ...
    def test_update_success(self, item_repository: ItemRepository, test_item: Item):
        """Test successful item update."""
        update_data = ItemUpdate(name="Updated Item", price=Decimal("199.99"))
    ...
    def test_update_partial(self, item_repository: ItemRepository, test_item: Item):
    ...
    def test_update_not_found(self, item_repository: ItemRepository, test_user: User):
    ...
    def test_delete_success(self, item_repository: ItemRepository, test_item: Item):
    ...
    def test_delete_not_found(self, item_repository: ItemRepository, test_user: User):
    ...
    def test_search_for_user_by_description(
        ...
        result = item_repository.search_for_user(test_item.user_id, "test item")
    ...
    def test_search_for_user_no_results(
        ...
        result = item_repository.search_for_user(test_user.id, "nonexistent item")
    ...
    def test_search_for_user_with_pagination(
        ...
        result = item_repository.search_for_user(user_id, "Test", skip=0, limit=2)
    ...
    def test_get_user_items_by_price_range_min_only(
        ...
        result = item_repository.get_user_items_by_price_range(user_id, min_price=10.0)
    ...
    def test_get_user_items_by_price_range_max_only(
        ...
        result = item_repository.get_user_items_by_price_range(user_id, max_price=15.0)
    ...
    def test_get_user_items_by_price_range_database_error(
        ...
        with patch.object(item_repository.session, "exec") as mock_exec:
            ...
            assert "Database error while retrieving items by price range" in str(
                exc_info.value
            )
...
class TestItemRepositoryIntegration:
    ...
    async def test_create_and_retrieve_item(
        self, item_repository: ItemRepository, test_user: User, test_data_factory
    ):
    ...
    async def test_update_and_verify_item(
        ...
        # Create item
        item_data = test_data_factory.create_item_data(
            name="Original Item", price=Decimal("10.00")
        )
        created_item = item_repository.create(item_data, test_user.id)

        # Update item
        update_data = ItemUpdate(name="Updated Item", price=Decimal("20.00"))
    ...
    async def test_delete_and_verify_item(
        ...
        # Create item
        item_data = test_data_factory.create_item_data(
            name="To Be Deleted", price=Decimal("5.00")
        )
        created_item = item_repository.create(item_data, test_user.id)
