...
class TestUserRepository:
    ...
    @pytest.mark.asyncio
    async def test_exists_by_line_user_id_false(
        self,
        user_repository: UserRepository
    ):
...
class TestUserRepositoryIntegration:
    ...
    async def test_create_and_retrieve_user(
        ...
        retrieved_by_line_id = await user_repository.get_by_line_user_id(user_data.line_user_id)
    ...
    async def test_delete_and_verify_user(
        ...
        # Create user
        user_data = test_data_factory.create_user_data(
            line_user_id="delete_test_user",
            display_name="To Be Deleted"
        )
        created_user = await user_repository.create(user_data)
        
        # Verify user exists
        assert await user_repository.exists_by_line_user_id(user_data.line_user_id) is True
        ...
        assert await user_repository.exists_by_line_user_id(user_data.line_user_id) is False