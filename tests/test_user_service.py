...
from src.api_server.models.user import User, UserCreate, UserUpdate, UserResponse
...
class TestUserService:
    ...
    async def test_get_user_by_line_id_success(
        ...
        # Verify repository call
        mock_repository.get_by_line_user_id.assert_called_once_with("test_line_user_123")
    ...
    async def test_create_user_from_line_profile_new_user(
        ...
        mock_repository.get_by_line_user_id.assert_called_once_with(sample_line_profile.userId)
    ...
    async def test_user_exists_true(
        ...
        # Assertions
        assert result is True
        mock_repository.exists_by_line_user_id.assert_called_once_with("test_line_user_123")
    ...
    async def test_user_exists_false(
        ...
        # Assertions
        assert result is False
        mock_repository.exists_by_line_user_id.assert_called_once_with("nonexistent_user")
    ...
    async def test_get_or_create_user_existing(
        ...
        result = await user_service.get_or_create_user_from_line_profile(sample_line_profile)
